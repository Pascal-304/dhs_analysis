...
This paper uses the Childcare While Working Data [@ghana1998] obtained from the Ghana Demographic and Health Survey 1998. The dataset was collected by downloading the final report of the 1988 Ghana census published in the Demographic and Health Surveys (DHS) programme (Do we need to cite dhs program as well?). The library 'pdftools' [@citepdftools] is used to download and read the content into R by parsing the pdf. 
